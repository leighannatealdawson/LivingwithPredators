...
export const questions: Question[] = [
  ...
  items: [
    {"id":"pm_woodland","label":"Pine marten is seen in its natural habitat (i.e. woodland)"},
    {"id":"pm_residential","label":"Pine marten is seen around residential homes (e.g., gardens, residential streets)"},
    {"id":"pm_farm","label":"Pine marten is seen around farms (e.g., farmyards, sheds, livestock areas)"},
    {"id":"pm_den","label":"Pine marten has denned in a house"},
    {"id":"pm_poultry_gamebirds","label":"Pine marten has attacked poultry (for example chickens and turkeys) and gamebirds (for example pheasants and grouse)"},
    {"id":"pm_bin","label":"Pine marten has been seen eating from a bin"}
  ],
},
{
  id: "fox_scenarios",
  ...
  anchors: ["Completely unacceptable","Unacceptable","Somewhat unacceptable","Neutral","Somewhat acceptable","Acceptable","Completely acceptable"],
  items: [
    {"id":"fox_woodland","label":"Fox is seen in its natural habitat (i.e. woodland)"},
    {"id":"fox_residential","label":"Fox is seen around residential homes (e.g., gardens, residential streets)"},
    {"id":"fox_farm","label":"Fox is seen around farms (e.g., farmyards, sheds, livestock areas)"},
    {"id":"fox_den","label":"Fox has denned in a house"},
    {"id":"fox_poultry_gamebirds","label":"Fox has attacked poultry (for example chickens and turkeys) and gamebirds (for example pheasants and grouse)"},
    {"id":"fox_bin","label":"Fox has been seen eating from a bin"}
  ],
},
  {
    id: "pm_risk",
