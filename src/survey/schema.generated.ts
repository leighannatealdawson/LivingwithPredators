...
export const questions: Question[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {"id":"pm_den","label":"Pine marten has denned in a house (e.g. resting, sleeping)"},
      {"id":"pm_poultry_gamebirds","label":"Pine marten has attacked poultry and gamebirds (e.g. chickens, turkeys, pheasants, grouse)"},
  ...
  },
  {
    ...
    items: [
      ...
      {"id":"fox_den","label":"Fox has denned in a house (e.g. resting or sleeping)"},
      {"id":"fox_poultry_gamebirds","label":"Fox has attacked poultry and gamebirds (e.g. chickens, turkeys, pheasants, grouse)"},
