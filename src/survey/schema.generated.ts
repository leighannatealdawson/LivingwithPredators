...
export const questions: Question[] = [
  ...
  },
  {
    ...
    rightLabel: "Completely acceptable",
    anchors: ["Completely unacceptable","Unacceptable","Somewhat unacceptable","Neutral","Somewhat acceptable","Acceptable","Completely acceptable"],
    items: [{"id":"fox_woodland","label":"Fox is seen in its natural habitat (i.e. woodland)"},{"id":"fox_residential","label":"Fox is seen around residential homes (e.g., gardens, residential streets)"},{"id":"fox_farm","label":"Fox is seen around farms (e.g., farmyards, sheds, livestock areas)"},{"id":"fox_den","label":"Fox has denned in a house (e.g. resting or sleeping)"},{"id":"fox_poultry_gamebirds","label":"Fox has attacked poultry (e.g. chickens and turkeys) and gamebirds (for example pheasants and grouse)"}],
  },
  {
    id: "pm_risk",
    kind: "slider-group",
