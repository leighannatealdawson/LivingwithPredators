...
export const questions: Question[] = [
  ...
  },
  {
    ...
    items: [{"id":"pm_woodland","label":"Pine marten is seen in its natural habitat (i.e. woodland)"},{"id":"pm_residential","label":"Pine marten is seen around homes or residential properties (i.e. gardens, yards)"},{"id":"pm_farm","label":"Pine marten is seen around farms or farmyards"},{"id":"pm_den","label":"Pine marten has denned in a house (living or resting)"},{"id":"pm_poultry_gamebirds","label":"Pine marten has attacked poultry and gamebirds (for example chickens, turkeys, pheasants, grouse)"},{"id":"pm_bin","label":"Pine marten has been seen eating from a bin"}],
  },
  {
    id: "fox_scenarios",
    kind: "slider-group",
    ...
    rightLabel: "Completely acceptable",
    anchors: ["Completely unacceptable","Unacceptable","Somewhat unacceptable","Neutral","Somewhat acceptable","Acceptable","Completely acceptable"],
    items: [{"id":"fox_woodland","label":"Fox is seen in its natural habitat (i.e. woodland)"},{"id":"fox_residential","label":"Fox is seen around homes or residential properties (i.e. gardens, yards)"},{"id":"fox_farm","label":"Fox is seen around farms or farmyards"},{"id":"fox_den","label":"Fox has denned in a house (living or resting)"},{"id":"fox_poultry_gamebirds","label":"Fox has attacked poultry and gamebirds (for example chickens, turkeys, pheasants, grouse)"},{"id":"fox_bin","label":"Fox has been seen eating from a bin"}],
  },
  {
    id: "pm_risk",
    kind: "slider-group",
